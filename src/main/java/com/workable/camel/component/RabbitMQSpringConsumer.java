...
public class RabbitMQSpringConsumer extends DirectConsumer implements MessageListener {
    ...
    public RabbitMQSpringConsumer(RabbitMQSpringEndpoint endpoint, Processor processor,
                                  RabbitMQSpringConfiguration configuration) {
        super(endpoint, processor);
        this.configuration = configuration;
        this.simpleMessageListenerContainer =
            new SimpleMessageListenerContainer(configuration.getCachingConnectionFactory());
